...
class RegisterActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        already_have_account_textView.setOnClickListener {
            Log.d("RegisterActivity", "Перехід на вікно аунтефікації")
...
//            requestCode == 0  && requestCode == Activity.RESULT_OK && data != null
    ...
    private fun uploadImageToFirebaseStorage(){
        ...
        ref.putFile(selectPhotoUri!!)
            ...
            .addOnFailureListener { e ->
                Log.e("RegisterActivity", "Ошибка при загрузке фото в Firebase Storage", e)
            }
    }
    ...
    private fun saveUserToFirebaseDatabase(profileImageUri: String){
        ...
        ref.setValue(user)
            ...
            .addOnFailureListener { e ->
                Log.e("RegisterActivity", "Ошибка при сохранении пользователя в Firebase Database", e)
            }
    }
}
